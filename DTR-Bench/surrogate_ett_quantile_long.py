...
parser.add_argument('--workspace_path', type=str, default="../NLOT/surrogate_models/ett_quantile_long/learned_w_potential/latest_0.pkl", help='Path to the trained OT workspace pickle file.')
...
ITER = args.iter
device = "cuda:0"
PLOT_DIR = f"ett_quantile_long_surrogate_plots/{RUN_NAME}"
os.makedirs(PLOT_DIR, exist_ok=True)
WORKSPACES_DIR = f"../NLOT/surrogate_models/ett_quantile_long/{RUN_NAME}/"
...
def main():
    ...
    ett_data = torch.load("../quantile_regression/hti_data_long/hti_data_combined.pt")
