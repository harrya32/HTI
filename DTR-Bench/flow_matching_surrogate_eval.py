...
parser.add_argument('--workspace_path', type=str, default="../NLOT/surrogate_models/ours_new.pkl", help='Path to the trained CFM model.')
...
def flow_forward(action, obs, lambda_val, cfm_models):
    ...
    flowforward_action = np.array(flowforward_action, dtype=np.float32)
