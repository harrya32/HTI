...
def dataset_name2datapath(dataset_name, working_dir):
    ...
    elif dataset_name == "diffusion_2moons":
        return os.path.join(working_dir, "mfm", "dataloaders", "diffusion_2moons_dropout.pt")
    elif dataset_name == "quantile_data_new":
        return os.path.join(working_dir, "mfm", "dataloaders", "quantile_data_new.pt")
    elif dataset_name == "reacher_data":
        return os.path.join(working_dir, "mfm", "dataloaders", "reacher_data.pt")
    elif dataset_name == "reward_weighting_data_0_10":
        return os.path.join(working_dir, "mfm", "dataloaders", "reward_weighting_data_0_10.pt")
    elif dataset_name == "reward_weighting_hinge_data":
        return os.path.join(working_dir, "mfm", "dataloaders", "reward_weighting_hinge_data.pt")
    else:
